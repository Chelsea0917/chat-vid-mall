        ...
        {navItems.map((item) => {
          ...
          if (item.isCenter) {
            return (
              ...
              >
                <div className="w-14 h-[72px] bg-gradient-primary flex items-center justify-center shadow-lg shadow-primary/30 hover:scale-110 transition-transform" style={{ borderRadius: '50% 50% 50% 50% / 60% 60% 40% 40%' }}>
